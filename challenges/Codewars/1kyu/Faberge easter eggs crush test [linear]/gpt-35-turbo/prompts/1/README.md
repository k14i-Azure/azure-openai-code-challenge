...
/*
Constraints:
* Never repeat `if` and `elif` conditions simply and slightly changing the values like:
"""
if n == 0:
    return (0, 0, 0, 0)
elif n == 1:
...
/*
Solution in a single smart, simple, structured and constructed function in Python:
*/
```